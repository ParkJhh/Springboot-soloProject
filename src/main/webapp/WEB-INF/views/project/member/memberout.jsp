...
<script src="/member/outguard.js"></script>
...
<div class="container">
    ...
    <div class="content">
        ...
        <br>
        <p style="font-size: 15px; font-weight:bold; color: white; line-height: 60px;" >탈퇴를 위해 아래 정보를 입력해주세요.</p>
        <form action="/member/outconfirm" method="post">
            <div class="user-details">
                ...
                <div class="input-box">
                    <span class="details">이메일 확인</span>
